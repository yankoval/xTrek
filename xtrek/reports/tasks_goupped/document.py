...
from .data import TasksGouppedReportData


REPORT_TITLE = "Отчет о заданиях с группировкой по артикулам"


def build(data: TasksGouppedReportData, *, include_details: bool = True) -> Report:
    ...
    if data.period is not None:
        ...
        metadata = {"report": "tasks-goupped", "date": data.day.isoformat()}
