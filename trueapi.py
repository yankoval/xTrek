...
def main():
    ...
    parser.add_argument('-ct', '--client_token', dest='client_token', type=str, help='Client Token')
    parser.add_argument('-oid', '--omsid', dest='omsId', type=str, help='OMS ID')
    ...
    parser.add_argument('--cises', action='store_true', help='Коды из буфера')
    parser.add_argument('--log-file', type=str, help='Путь к файлу лога')
