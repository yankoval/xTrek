...
python trueapi.py --balance --find-token-by-inn 9723161905 --log-file nk.log
python nk.py --owngtins --find-token-by-inn 9723161905
python nk.py --linked-gtins --find-token-by-inn 9723161905
python trueapi.py --balance --find-token-by-inn 9718180660 --log-file nk.log
python nk.py --owngtins --find-token-by-inn 9718180660
python nk.py --linked-gtins --find-token-by-inn 9718180660
python trueapi.py --balance --find-token-by-inn 7733154124 --log-file nk.log
